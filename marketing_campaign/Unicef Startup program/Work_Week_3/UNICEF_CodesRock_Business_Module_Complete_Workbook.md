...
```mermaid
gantt
    title CodesRock Scaling Timeline & Revenue Stream Rollout
    dateFormat  YYYY-MM
    section Streams
    B2B Onboarding (₵5,850 Private / ₵3,600 Public)  :active, des1, 2026-06, 12m
    B2B Activity Books (₵150 Private / ₵50 Public)    :active, des2, 2026-06, 12m
    B2B Portal Sub (₵50/T + ₵5/S starting Term 2)     :active, des3, 2026-09, 9m
    B2C Home Kits (₵2,430/kit)                        :active, des4, 2026-08, 10m
```
...
### 3. 12-Month Bottom-Up Revenue Forecast (Private-School Focus)
...
```mermaid
graph LR
    Parent["Parent experiences screen-time anxiety"] --> B2C["Discovers CodesRock online / buys Home Kit"]
    B2C --> Advocate["Parent shares Activity Book with School Head"]
    Advocate --> Pitch["CodesRock pitches School Head (GHS 5,850 standard onboarding)"]
    Pitch --> Rollout["School adopts program, transferring cost indirectly to parents"]
    Rollout --> Group["Children code together screen-free, driving more parent word-of-mouth"]
    Group --> Parent
```
